...
/* Animation when screen4 becomes active */
#screen4.active .option-btn:nth-child(1){
    animation:leftIn .7s ease forwards;
}

#screen4.active .option-btn:nth-child(2){
    animation:rightIn .7s ease .15s forwards;
}

#screen4.active .option-btn:nth-child(3){
    animation:bottomIn .7s ease .30s forwards;
}

#screen4.active .option-btn:nth-child(4){
    animation:topIn .7s ease .45s forwards;
}

@keyframes leftIn{
    from{
        opacity:0;
        transform:translateX(-250px) scale(.7);
    }
    to{
        opacity:1;
